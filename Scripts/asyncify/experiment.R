...
for(n in 0:max_n) {
  ...
  system(paste('python3 Scripts/asyncify/prepare_wat.py programs/wasm/asyncify_thread.watt', n, "> asyncify_sub.wat"))
  system('wasm-opt asyncify_sub.wat -O --asyncify --print > asyncify_runnable.wat')
  ...
  for(s in 1:samples) {
    ...
    asyncify_dt <- sys_dt('/Users/donaldpinckney/.cargo/bin/wasmtime asyncify_runnable.wat --invoke runtime')

(module
 ...
 (func $queue_addr (; 2 ;) (param $0 i32) (result i32)
  (i32.add
 ...
 (func $thread_id_stack_info_addr (; 5 ;) (param $0 i64) (result i32)
  (i32.add
 ...
 (func $thread_id_result_addr (; 6 ;) (param $0 i64) (result i32)
  (i32.shl
   (i32.wrap_i64
    (local.get $0)
   )
